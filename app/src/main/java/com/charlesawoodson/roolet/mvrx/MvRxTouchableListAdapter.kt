...
import com.charlesawoodson.roolet.extensions.moveItem
import com.charlesawoodson.roolet.extensions.removeItem

abstract class MvRxTouchableListAdapter<T : Any>(fragment: Fragment) :
    MvRxListAdapter<T>(fragment) {
    ...
    protected open val touchHelperCallback by lazy(mode = LazyThreadSafetyMode.NONE) {
        MvRxItemTouchHelperCallback(this)
    }
